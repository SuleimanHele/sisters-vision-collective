  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="max-w-3xl mx-auto text-center"> {/* Adicionei mx-auto e mantive text-center */}
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-primary-foreground mb-4 sm:mb-6 leading-snug sm:leading-tight animate-fade-in">
            The Sisters Vision
          </h1>
          <p className="text-lg sm:text-xl md:text-2xl lg:text-3xl text-secondary mb-6 sm:mb-8 font-light animate-fade-in-delay-1">
            Construímos hoje os negócios que moldam o amanhã
          </p>
          <p className="text-sm sm:text-base md:text-lg lg:text-xl text-primary-foreground/90 mb-8 sm:mb-12 max-w-2xl leading-relaxed animate-fade-in-delay-2 mx-auto"> {/* Mantive mx-auto aqui também */}
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center animate-fade-in-delay-3"> {/* Mantive justify-center */}
            <Button
              size="lg"
